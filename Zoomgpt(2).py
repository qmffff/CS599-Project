...
def chat_with_gpt4(prompt, model="gpt-4-1106-preview", temperature=0.7, max_tokens=150,
                   api_key='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'):
...
def gpt_conference(start_prompt, meeting_topic, turns=5):
    ...
    for turn in range(turns):
        ...
        if turn == turns - 1:
            current_prompt += f"\n\nYou are the host of this meeting, the above is all the content of this meeting, please summarize this meeting and give your concluding remarks"
